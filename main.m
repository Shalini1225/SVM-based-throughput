...
%% plotting base stations, PU and SU 
...
%% plotting user throughput of CRN-1 
figure()
...
%% plotting min throughput comparison of all networks 
index=1:N_network;
figure(103)
hold on
...
%% plotting total throughput comparison of all network
...
plot(throughput_COMP_v2_total/10^6,0.4)
set(gca,'XTick',index)
xlim([0 N_network+1])
ylim([0 290])
ylabel('Throughput (Mbps)','FontSize',12)
